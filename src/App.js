...
const ShopGride = loadable(() => pMinDelay(import ('./page/shop/shop-electronics'), 250), { fallback: <Loading />});
const ShopGridf = loadable(() => pMinDelay(import ('./page/shop/shop-furniture'), 250), { fallback: <Loading />});
const ShopGridfa = loadable(() => pMinDelay(import ('./page/shop/shop-fashion'), 250), { fallback: <Loading />});
      ...
      <BrowserRouter>
        <Router>
          ...
          <Switch>
            ...
            <Route path='/shop/electronics' exact component={ShopGride} />
            <Route path='/shop/furniture' exact component={ShopGridf} />
            <Route path='/shop/fashion' exact component={ShopGridfa} />

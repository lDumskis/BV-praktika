...
export const ProductDetailsTwo = () => {


    const [state, dispatcht] = useReducer(reducer, initialState);
    ...
    // Add to cart
    const addToCart = async (id, val) => {
        dispatch({ type: "products/addToCart", payload: { id, val } })
    }
                                        ...
                                        <div className="product_count_one">
                                            <div className="plus-minus-input">
                                                <div className="input-group-button">
                                                    <button type="button" className="button" onClick={() => dispatcht({type: 'decrement'})}>
                                                        <i className="fa fa-minus"></i>
                                                    </button>
                                                </div>
                                                <input className="form-control" type="number" value={state.count - 1} readOnly />
                                                <div className="input-group-button">
                                                    <button type="button" className="button" onClick={() => dispatcht({type: 'increment'})}>

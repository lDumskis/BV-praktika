                            ...
                            <div className="account_form">
                                ...
                                <form onSubmit={(e)=>{e.preventDefault();login()}}>
                                    <div className="default-form-box">
                                        ...
                                        <input type="text" className="form-control" required defaultValue="lukas.dumskis@bazaarvoice.com"/>
                                    </div>
                                    <div className="default-form-box">
                                        <label>Passwords<span className="text-danger">*</span></label>
                                        <input type="password" className="form-control" required defaultValue="Lukas" minLength="8"/>
                                    </div>

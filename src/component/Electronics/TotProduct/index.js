                            ...
                            <div className="tabs_el_wrapper">
                                <div className="tab-content">
                                    <div id="video" className="tab-pane fade show in active">
                                        <div className="row">
                                            {products.filter(product => product.category.includes('electronics') && product.labels.includes('New')).map((data, index) => (
                                    ...
                                    <div id="camera" className="tab-pane fade">
                                        <div className="row">
                                        {products.filter(product => product.category.includes('fashion')).map((data, index) => (
                                                <div className="col-lg-3 col-md-4 col-sm-6 col-12" key={index}>
                                                    <ProductCard data={data} />
                                                </div>
                                            ))}

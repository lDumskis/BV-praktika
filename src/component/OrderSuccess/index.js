                ...
                <Helmet>
                    <script type="text/javascript">{
                        BV.pixel.trackTransaction({
                            ...
                            "email": "lukas.dumskis@bazaarvoice.com",
                            "locale": "en_US",
                            "nickname": "Lukas"
                        })
                    }</script>
                                ...
                                <table className="order-detail" border="0" cellPadding="0" cellSpacing="0" align="left">
                                    <tbody>
                                        ...
                                        {carts.map((data, index) => (
                                            <tr key={index}>
                                                <td>
                                                    <img src={data.img} alt="img" width="70" />
                                                </td>
                                                <td valign="top" style={{ paddingLeft: "15px" }}>
                                                    <h5 style={{ marginTop: "15px" }}>{data.title}</h5>
                                                </td>
                                                <td valign="top" style={{ paddingLeft: "15px" }}>
                                                    <h5 style={{ fontSize: "14px", color: "#444", marginTop: "10px" }}>QTY : <span>{data.quantity || 1}</span></h5>
                                                </td>
                                                <td valign="top" style={{ paddingLeft: "15px" }}>
                                                    <h5 style={{ fontSize: "14px", Color: "#444", marginTop: "15px" }}><b>${data.price * (data.quantity || 1)}.00</b></h5>
                                                </td>
                                            </tr>
                                        ))
                                        }
